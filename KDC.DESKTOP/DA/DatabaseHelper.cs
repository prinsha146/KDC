...
namespace KDC.DESKTOP.DA
{
    ...
    public class DatabaseHelper : IDisposable
    {
        ...
        {
            databaseToUse = SupportedDatabases.SqlServer;
        ...
        /// </summary>
        public void ConnectionStringSettings(string connectionString)
        {
            ...
            try
            {
                ...
                switch (providerName)
                {
                    ...
                    case PROVIDER_ODBC_CLIENT:
                        ...
                        break;
                   /* case PROVIDER_SQL_CE_CLIENT:
                        newFactory = SqlCeProviderFactory.Instance;
                        break; */
                }
            }
            catch (Exception ex)
